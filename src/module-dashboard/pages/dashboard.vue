    ...
    <!-- <div style="width:55%;float:left;margin-bottom:1%">
      <el-card class="sales-card">
        <div class="clearfix">
          <div class='fl headL'>
            <div class="headImg">
              <img style="width:100px;height:50px" src="../assets/logo.jpg"/>
            </div>
            <div class="headInfoTip">
              <p class="firstChild">早安，HMI，祝你开心每一天！</p>
              <p class="lastChild">HMI   |  恒润科技</p>
            </div>
          </div>
          <div class="fr">
      ...
      <div style="width:55%;float:left;margin-bottom:1%">
        <el-card class="box-card">
            ...
            <div class="sideNav">
              ...
              <ul class="clearfix">
                <li>
                  <a href="#/city/cityList">城市列表</a>
                </li>
                <li>
                  <a href="#/project/projectList">项目列表</a>
                </li>
                <li>
                  <a href="#/car/carList">车辆列表</a>
                </li>
                <li>
                  <a href="#/car/addCar">添加车辆</a>
                </li>
                <li>
                  <a href="#/route/routeList">路线列表</a>
                </li>
                <li>
                  <a href="#/route/addRoute">添加路线</a>
                </li>
